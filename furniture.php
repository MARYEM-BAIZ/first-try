...
<head>
    ...
    <link rel="stylesheet" href="furtiture.css">
     ...
     <main>
         <section class="section1">
             <article>
                ...
                <p>FREE SHIPPING</p>
                <h6>Free Shipping On All Order Over 100.00</h6>
             </article>
             <article>
                <i class="fa fa-volume-control-phone" aria-hidden="true"></i>
                <p>ONLINE SUPPORT 24/7</p>
                <h6>We Will Assist You With All Your Inquiries</h6>
             </article>
             <article>
                <i class="fa fa-usd" aria-hidden="true"></i>
                <p>MONEY BACK GURANTEE</p>
                <h6>Free 100% Refound For 30 Days</h6>
             </article>
         </section>
        ...
        <div  class="divsection3">
            <p><strong>SMART FURNITURE COLLECTION</strong></p>
            <h6>Lorem ipsum dolor sit amet consectetur adipisicing.</h6>
            <h6 class="h6section3"><span>View Collection</span></h6>
        </div>
         </section>
         <section class="section4" >
             <p class="h1">FEATURED PRODUCTS</p>
         ...
         <section>
             <div id="divsection5">
               ...
               <a href="" id="btnsliderdroite"><i class="fa fa-arrow-right" aria-hidden="true"></i></a>
             </div>
         </section>
         <section class="secton6">
             <p class="psection6">NEWSLETTER</p>
             <h4 class="h6section6">Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptas aliquam suscipit dicta perspiciatis laudantium architecto, exercitationem optio atque totam illo!</h4>
             <div class="divsection6">
                 <input type="email" name="email" id="emailsection6" placeholder="Enter Your Email">
                 <i id="iconsection6" class="fa fa-envelope" aria-hidden="true"></i>
             </div>
             <input type="submit" name="submitsection6" id="submitsection6" value="subscribe">
         </section>
     </main>
...
bouton.addEventListener("click",function(event){
    ...
    // document.body.menu.classList.add ("tarsi")
    ...
    const btn1= document.getElementById("btn1")
       ...
       btn1.addEventListener("click",function(event){
           event.preventDefault()
           btn1.classList.add("divanav")
           btn2.classList.remove("divanav")
           btn3.classList.remove("divanav")
           btn4.classList.remove("divanav")
       })
       ...
       btn2.addEventListener("click",function(event){
           event.preventDefault()
           btn1.classList.remove("divanav")
           btn2.classList.add("divanav")
           btn3.classList.remove("divanav")
           btn4.classList.remove("divanav")
       })
       ...
       btn4.addEventListener("click",function(event){
           ...
           btn2.classList.remove("divanav")
           btn3.classList.remove("divanav")
           btn4.classList.add("divanav")
       })

    //    slider//////////////////////////////////////

        const btndroite = document.getElementById("btnsliderdroite")
        const btnsgauche = document.getElementById("btnslidergauche")
        ...
        const imgslider4 =document.getElementById("imgslider4")
        const imgslider5 =document.getElementById("imgslider5")
        const imgslider6 =document.getElementById("imgslider6")
